...
public class Solution extends SimpleFileVisitor<Path> {
    ...
    {
        if (file.toString().endsWith(".zip") || file.toString().endsWith(".rar"))archived.add(file.toFile().getAbsolutePath());
    ...
    {
        if (!file.toFile().canRead())failed.add(file.toFile().getAbsolutePath());
