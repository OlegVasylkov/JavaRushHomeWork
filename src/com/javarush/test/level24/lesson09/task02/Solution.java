...
public class Solution {
    ...
    public static void sort(List<Stock> list) {
        Collections.sort(list, new Comparator<Stock>() {
            public int compare(Stock stock1, Stock stock2) {
                ...
                double profit1 = (stock1.containsKey("change") ? (double)stock1.get("change") : (double)stock1.get("last")-(double)stock1.get("open"));
                double profit2 = (stock2.containsKey("change") ? (double)stock2.get("change") : (double)stock2.get("last")-(double)stock2.get("open"));
    ...
    public static List<Stock> getStocks() {
        ...
        stocks.add(new Stock("Fake Sirius Satellite", "SIRI", .03, getRandomDate()));
        stocks.add(new Stock("Fake Sirius Satellite", "SIRI", -.06, getRandomDate()));
        stocks.add(new Stock("Fake Sirius Satellite", "SIRI", .06, getRandomDate()));
