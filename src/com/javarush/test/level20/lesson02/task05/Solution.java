...
public class Solution
{
    ...
    public static class Object
    {
        ...
        public void save(OutputStream outputStream) throws Exception
        {
            ...
            string1.print();
            java.lang.String result1 = outputStream1.toString();

            ByteArrayOutputStream outputStream2 = new ByteArrayOutputStream();
            System.setOut(new PrintStream(outputStream2));
            string2.print();
            java.lang.String result2 = outputStream2.toString();
            System.setOut(consoleStream);

            printStream.println(result1);
            printStream.println(result2);
        ...
        public void load(InputStream inputStream) throws Exception
        {
            ...
            {
                tmp = countStrings;
                java.lang.String[] mass = s.split("#");
                countStrings = Integer.parseInt(mass[1]) - 1;
                string1 = new String();
                countStrings = tmp;
            }
            reader.readLine();
