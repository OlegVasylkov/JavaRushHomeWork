...
public class Solution
{
    ...
    {
        BigInteger i = new BigInteger(number.getDigit(), number.getNumerationSystem().getNumerationSystemIntValue());
        if (i.compareTo(BigInteger.ZERO) < 0) throw new NumberFormatException();
        else
            return new Number(expectedNumerationSystem, i.toString(expectedNumerationSystem.getNumerationSystemIntValue()));
    }
}
