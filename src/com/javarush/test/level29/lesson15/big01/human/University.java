...
public class University {
    ...
    public Student getStudentWithMaxAverageGrade() {
        ...
        for (Student student : students){
            if (student.getAverageGrade() > studentWithMaxAverageGrade.getAverageGrade()) studentWithMaxAverageGrade = student;
        }
    ...
    public Student getStudentWithMinAverageGrade() {
        ...
        for (Student student : students){
            if (student.getAverageGrade() < studentWithMinAverageGrade.getAverageGrade()) studentWithMinAverageGrade = student;
        }
